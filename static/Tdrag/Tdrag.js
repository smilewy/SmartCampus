  ...
  jQuery(function () {
    ...
    Dragfn.prototype = {
      ...
      collTestBox: function (obj, obj2) {
        ...
        var t2 = $(obj2).innerHeight()+ $(obj2).scrollTop()- $(obj).outerHeight();
        return {
          lmin: l1,//取的l最小值
          tmin: t1,//取的t最小值
          lmax: l2,//取的l最大值
      ...
      pointDrag: function (obj) {
        ...
        if (oNear) {
          ...
          var tmp, col, row,number;
          tmp = $(obj).attr("index");
          col = $(obj).attr("data-col");
          row = $(obj).attr("data-row");
          $(obj).attr("index", $(oNear).attr("index"));
          $(obj).attr("data-col", $(oNear).attr("data-col"));
          $(obj).attr("data-row", $(oNear).attr("data-row"));
          $(oNear).attr("index", tmp);
          $(oNear).attr("data-col", col);
          $(oNear).attr("data-row", row);
