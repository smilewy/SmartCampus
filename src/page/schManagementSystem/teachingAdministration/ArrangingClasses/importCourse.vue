      ...
      <section class="g-section">
        ...
        <div class="gs-table alertsList">
          <el-table ref="studentMsgTable" :data="headerButtonData.studentBasicMsg" style="width:100%" @sort-change="sortChange" @selection-change="handleStudentTable">
            ...
            <el-table-column label="序号" sortable="custom"></el-table-column>
            <el-table-column label="班级"></el-table-column>
            <el-table-column label="座号" sortable="custom"></el-table-column>
            <el-table-column label="姓名" sortable="custom"></el-table-column>
            <el-table-column label="性别" sortable="custom"></el-table-column>
            <el-table-column label="手机号" sortable="custom"></el-table-column>
            <el-table-column label="科类" sortable="custom"></el-table-column>
          </el-table>
        </div>
      </section>
    ...
    methods:{
      ...
      chooseFile(event){
        ...
        if(!fileTypeCheck(this.extractFilename($(event.currentTarget).val()),['.xls','.xlsx'])){
          this.vmMsgWarning('文件不符合,请选择excel文件(*.xls或*.xlsx)!');
        }else{
