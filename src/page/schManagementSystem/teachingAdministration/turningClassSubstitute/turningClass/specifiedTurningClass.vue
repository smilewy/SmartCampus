<template>
  <div class="specifiedTurningClass">
    ...
    <el-row :gutter="20" class="specifiedTurningClass_row">
      <el-col :span="9">
          ...
          <el-row type="flex" align="middle" class="scheduleSearch">
            <el-col :span="14">
              <el-row :gutter="10" type="flex" align="middle">
                ...
                <el-col :span="8">
                  <el-select v-model="selectParam.gradeId" placeholder="请选择" style="width: 100%;" @change="chooseClass">
                    <el-option
                ...
                <el-col :span="8">
                  <el-select v-model="selectParam.classIdOne" placeholder="请选择" style="width: 100%;"
          ...
          <el-row type="flex" align="middle" class="scheduleSearch">
            <el-col :span="14">
              <el-row :gutter="10" type="flex" align="middle">
                ...
                <el-col :span="14">
                  <el-select v-model="selectParam.classIdTow" placeholder="请选择" style="width: 100%;"
...
<style>
  ...
  .specifiedTurningClass .scheduleContent_body td {
    width: 12.5%;
    text-align: center;
  ...
  .specifiedTurningClass .dateTime {
    font-size: 12px;
  }

  .specifiedTurningClass .weekTime {
    font-size: 14px;
  }

  .specifiedTurningClass .scheduleContent_head td {
    font-size: 14px;
    padding: .6rem 0;
  }

  .specifiedTurningClass td + td {
  ...
  .specifiedTurningClass .scheduleContent_body .schedule_box {
    padding: 2.25rem 0;
    position: relative;
  }

  .specifiedTurningClass .closeClass {
    position: absolute;
    right: .5rem;
    top: .5rem;
    font-size: 12px;
  ...
  .specifiedTurningClass .scheduleContent_body .schedule_box.schedule_box_act {
  ...
  .specifiedTurningClass .schedule_subject_normal .tips {
    position: absolute;
    bottom: -100%;
    left: 50%;
  ...
  .specifiedTurningClass .schedule_subject_normal .tips p {
    margin: .5rem 0;
  }

  .specifiedTurningClass .schedule_box:hover .tips {
    display: block;
  }

  .specifiedTurningClass .noDataTips {
    text-align: center;
    padding: 1rem 0;
    font-size: .875rem;
  }

  .specifiedTurningClass .treeList {
    border: 1px solid #d2d2d2;
    border-radius: 5px;
    height: 52.25rem;
  }

  .specifiedTurningClass .treeList_body {
    padding: .875rem;
    height: 45rem;
    overflow: auto;
  }

  .specifiedTurningClass .treeList_title {
    padding: .875rem;
  }

  .specifiedTurningClass .treeList_title h5 {
    font-size: 1rem;
  }

  .specifiedTurningClass .treeList .treeInput {
    margin: .875rem 0 0;
  }

  .specifiedTurningClass .treeList .el-tree {
    border: none;
  }

  .specifiedTurningClass .el-input-group--prepend .el-input__inner {
    border-radius: 20px;
    border-top-left-radius: 0;
    border-bottom-left-radius: 0;
  }

  .specifiedTurningClass .el-input-group__prepend {
    border-radius: 20px;
