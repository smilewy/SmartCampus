<template>
  <div class="InformationService StudentConfirmation">
    <h3>学生参考确认</h3>
    <el-row>
      <el-col :span="24" class="Infor-head">
        ...
        <el-col :span="4" :offset="19">
          ...
          <el-col :span="2" :offset="12">
            <el-button type="primary" class="Infor-search-1" @click="SaveChange()">保存</el-button>
          </el-col>
        </el-col>
      </el-col>
...
//        })
    ...
    methods: {
      operationData(type){
        ...
        if (type === 'copy') {
          req.copyTableData('.StudentConfirmation', sAy);
        } else {
          req.lodop(sAy);
        }
      },
