    ...
    <el-dialog
      ...
      <el-row class="alertDetail_list clear_fix">
        <div v-for="actImg in actData.accessory">
          <img src="../../../../assets/img/schManagementSystem/campusOffice/notificationNotice/icon_word.png" alt=""
               v-if="actImg.aName.split('.')[actImg.aName.split('.').length-1]=='doc'||actImg.aName.split('.')[actImg.aName.split('.').length-1]=='docx'">
          <img src="../../../../assets/img/schManagementSystem/campusOffice/notificationNotice/icon_ppt.png" alt=""
               v-if="actImg.aName.split('.')[actImg.aName.split('.').length-1]=='ppt'">
          <img src="../../../../assets/img/schManagementSystem/campusOffice/notificationNotice/icon_excel.png" alt=""
               v-if="actImg.aName.split('.')[actImg.aName.split('.').length-1]=='xlsx'||actImg.aName.split('.')[actImg.aName.split('.').length-1]=='xlsm'">
          <span :title="actImg.aName">{{actImg.aName}}</span>
        </div>
      </el-row>
    </el-dialog>
  </div>
