<template>
  <div class="LeaveRecord">
    <el-col :span="24">
      <h3 class="DocAp-title">场地申请审批</h3>
...
<script>
  export default{
    ...
    created(){
      ...
      if(this.$route.path.indexOf('/Fieldapprovel/FieldApproved')>-1){
        this.$router.push('/Fieldapprovel')
      }
    },
    methods:{
      toggleTitleClass:function(index){
        ...
        if(index===0){
          ...
          this.$router.push('/Fieldapprovel/FieldApproved')
        }
      },
