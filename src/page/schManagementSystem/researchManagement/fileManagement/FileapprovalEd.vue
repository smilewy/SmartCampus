  ...
  <div class="FilerecordEd">
    <el-row class="LeaveRecord-title" type="flex" align="center">
      <el-form :inline="true" class="formInline">
        ...
        <el-form-item>
          <el-button type="primary" icon="el-icon-search" class="LeaveRecord-search" @click="GetFileAppList(1)">查询</el-button>
        </el-form-item>
      </el-form>
    </el-row>
    <el-row>
      ...
      <el-row class="alertsList">
        <el-table
          ...
          <el-table-column
            ...
            align="center">
            <template slot-scope="scope">
              <span>{{scope.row.owner.join('、')}}</span>
            </template>
          </el-table-column>
          <el-table-column
            prop="time"
          ...
          <el-table-column
            ...
            <template slot-scope="scope">
              ...
              <span v-if="scope.row.status==2" style="color: #ff5b5b">未通过</span>
            </template>
          </el-table-column>
          <el-table-column
            label="操作"
...
<script>
  ...
  export default{
    ...
    methods:{
      ...
      download(row){
        let id=row.accId;
        req.downloadFile('.FilerecordEd','/school/FileManage/fileApprove?type=downloadAcc&accId='+id,'post');
      },
      handleIconClick(){
        this.GetFileAppList();
      },
      ...
      ShowDatils(row){
        ...
        row.tagStr = row.tag.map(val=>val.tag).join('、');
        this.dialogData=row;
...
<style lang="less" scoped>
  .FilerecordEd .FilerecordPassed-checkbox{
  ...
  .FilerecordEd  .el-checkbox-group .el-checkbox{
    margin-left: 0;
    margin-top: .6rem;
    margin-right: .6rem;
  }
  .FilerecordEd .Field-save{
    position: absolute;
    bottom: 1.4rem;
    padding: .6rem 2.6rem;
    border-radius: 1.1rem;
  }
  .FilerecordEd .Hidecheckbox-btn{
    margin-top: 1.6rem;
    padding: .35rem 1rem;
  }
  .LeaveRecord-title{
