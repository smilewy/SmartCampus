      ...
      <div class="g-sectionC">
        ...
        <section class="gL-section">
          <el-tree
            ...
            @check-change="checkChange" :highlight-current="true" show-checkbox node-key="id" :data="treeData" :props="defaultProps" ref="allMsg" @node-click="handleNodeClick"></el-tree>
        </section>
      </div>
