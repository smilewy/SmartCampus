  ...
  export default{
    ...
    methods:{
      operationData(type){
        ...
        if (type === 'copy') {
          req.copyTableData('.StatisticsOfTeacher', sAy);
        } else {
          req.lodop(sAy);
        }
      },
      download(){
        ...
        req.downloadFile('.StatisticsOfTeacher','/school/StudentEvaluate/statisticsEvaluate?export=ensure&option=teacher&gradeId='+gradeId+'&evaId='+evaId,'post');
      },
      getclass(){
        let param={
          func:'getAllEva'
