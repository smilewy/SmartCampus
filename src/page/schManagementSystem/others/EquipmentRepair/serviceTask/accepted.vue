  ...
  <div class="g-statisticalAnalysis g-container repairaccepted">
    ...
    <section class="centerTable alertsList">
      ...
      <el-table class="g-NotHover" 
        ...
        <el-table-column label="维修反馈" min-width="150" prop="feedback" sortable="custom">
        </el-table-column>
      </el-table>
    </section>
  ...
  export default{
    ...
    methods:{
      ...
      getLoadAjax(){
        ...
        serviceTaskLoad({repairType:'list',...this.repairForm,state:4,...this.orderParam,valueData:this.fuzzyInput}).then(data=>{
