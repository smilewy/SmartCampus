...
<!--      <div class="defineSelect g-sa_header_left">
    ...
    <section class="alertsList centerTable">
      <el-table v-loading="loading"
        ...
        <el-table-column label="科目" prop="teachingSubjects" sortable="custom"></el-table-column>
  ...
  export default{
    ...
    methods:{
      ...
      getTableLoad(){
        if(this.questionId){
          this.loading = true;
          questionNaireRecordProgress({roleNameId:1,questionId:this.questionId,page:this.currentPage,pageSize:this.pageCount,valueData:this.fuzzyInput,...this.orderBy}).then(data=>{
            this.loading = false;
            if(data.statu){
