  ...
  <div class="g-container">
    <header class="g-header">
      ...
      <div class="gh-section notRequire clear_fix">
        <el-form ref="studentMessge" :rules="studentMsgRules" label-position="left" :model="dataHeader"
                 label-width="72px">
    ...
    <section class="g-section">
      ...
      <div class="gs-table alertsList">
        <el-table class="g-fixedColumn" v-show="headerButtonData.hasBasicData" ref="studentMsgTable"
          ...
          <el-table-column min-width="180" v-for="(content,index) in headerButtonData.studentBasicTr" :key="index"
                           :label="content.zh" :prop="content.en" sortable="custom">
            <template slot-scope="scope">
              <span
                v-if="content.en=='isTempStudy'||content.en=='isLeave'||content.en=='isSubor'||content.en=='isSingleton'||content.en=='isPreschool'||content.en=='isBehChild'||content.en=='isTraChild'||content.en=='isOrphan'||content.en=='isMartyrChild' || content.en == 'isTakeSchoolBus' || content.en == 'isSubsidy' || content.en == 'isApplyFund' || content.en == 'isGovBuyDegree'">
                <span v-if="scope.row[content.en]==1">是</span>
                <span v-if="scope.row[content.en]==0">否</span>
              </span>
              <span
                v-else-if="content.en=='healthStatus'">
                <span v-if="scope.row[content.en]==0">健康</span>
                <span v-if="scope.row[content.en]==1">良好</span>
                <span v-if="scope.row[content.en]==1">差</span>
              </span>
              <img v-else-if="content.en=='logo'" :src="scope.row[content.en]" />
              <span v-else>{{scope.row[content.en]}}</span>
            </template>
          </el-table-column>
        ...
        <el-row :gutter="30">
          <el-col :span="11">
            ...
            <el-form-item label="班级：" prop="classId">
              <el-select v-model="updateData.student_info.classId" style="width:100%;" placeholder="请选择班级"
                         @change="changeNumber">
            ...
            <el-form-item label="身份证类型：">
              <el-select v-model="updateData.student_info.idCardType" style="width:100%;" placeholder="请选择身份证类型">
          ...
          <el-col :span="11">
            ...
            <el-form-item label="政治面貌：">
              <el-select v-model="updateData.student_info.political" style="width:100%;" placeholder="请选择政治面貌">
            ...
            <el-form-item label="学生卡号：">
              <el-input v-model="updateData.student_info.studentCard" :disabled="true"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
        ...
        <el-row :gutter="30">
          <el-col :span="11">
            ...
            <el-form-item label="科类：">
              <span>{{updateData.school_rollinfo.stream}}</span>
            </el-form-item>
          ...
          <el-col :span="11">
            ...
            <el-form-item label="专业：">
              <span>{{updateData.school_rollinfo.major}}</span>
            </el-form-item>
        ...
        <el-row :gutter="0">
          <el-col :span="12">
            ...
            <el-form-item label="家长1身份证类型：">
              <el-select v-model="updateData.parents_info.jzCardType1" style="width:100%;" placeholder="请选择家长1身份证类型">
                <el-option :label="idCardType.value" :value="idCardType.value" v-for="(idCardType,ix) in idCardTypeData" :key="ix"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
        ...
        <el-row :gutter="0">
          <el-col :span="12">
            ...
            <el-form-item label="家长2身份证类型：">
              <el-select v-model="updateData.parents_info.jzCardType2" style="width:100%;" placeholder="请选择家长2身份证类型">
                <el-option :label="idCardType.value" :value="idCardType.value" v-for="(idCardType,ix) in idCardTypeData" :key="ix"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
  ...
  export default{
    ...
    methods: {
      ...
      operationData(type) {
        let sAy = [], hdData;
        hdData = {};
        for (let obj of this.headerButtonData.studentBasicTr) {
        ...
        for (let obj of this.headerButtonData.studentBasicMsg) {
          ...
          for (let name in hdData) {
            if (name == 'isTempStudy' || name == 'isLeave' || name == 'isSubor' || name == 'isSingleton' || name == 'isPreschool' || name == 'isBehChild' || name == 'isTraChild' || name == 'isOrphan' || name == 'isMartyrChild' || name == 'isTakeSchoolBus' || name == 'isSubsidy' || name == 'isApplyFund' || name == 'isGovBuyDegree') {
              d[name] = obj[name] == 1 ? '是' : '否';
