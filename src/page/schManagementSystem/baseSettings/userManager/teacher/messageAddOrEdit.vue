      ...
      <el-row type="flex" justify="center" :gutter="100">
        <el-col :span="10">
          <el-form ref="form1" :model="form" :rules="rules" label-width="120px">
            ...
            <el-form-item label="任教科目：" prop="teachingSubjectsId">
              <el-select v-model="form.teachingSubjectsId" placeholder="请选择任教科目" style="width: 100%;">
                <el-option :label="subject.subjectname" :value="subject.subjectid" :key="subject.subjectid"
  ...
  export default {
    ...
    created: function () {
      ...
      if (type == 0) {
        ...
        self.titleTxt = '教师信息修改';
        data = {
          id: this.$route.params.id
        };
        req.ajaxSend('/school/User/userGl?type=getTeacherById', 'get', data, function (res) {
          self.form = res.data;
            ...
            self.$refs['form2'].validate((valid) => {
              if (valid) {
                if (self.titleTxt == '教师补录') {
                  ...
                  req.ajaxSend('/school/user/userGl?type=updataTeacher', 'post', data, function (res) {
                    if (res.statu == 1) {
