...
export default new Router({
  ...
  routes: [
    ...
    /*成绩对比*/
    {
      path:'/scoreCompare',
      name:'scoreCompare',
      component:resolve=>require(['@/page/schManagementSystem/teachingAdministration/studentScores/compare/scoreCompare.vue'],resolve)
    },
    /*名次对比*/
    {
      path:'/RankCompare',
      name:'RankCompare',
      component:resolve=>require(['@/page/schManagementSystem/teachingAdministration/studentScores/compare/RankCompare.vue'],resolve)
    },
    /*均分对比*/
    {
      path:'/AvgCompare',
      name:'AvgCompare',
      component:resolve=>require(['@/page/schManagementSystem/teachingAdministration/studentScores/compare/AvgCompare.vue'],resolve)
    },
    /*模拟上线——总分上线*/
    {
      path:'/totalScoreLine',
      name:'totalScoreLine',
      component:resolve=>require(['@/page/schManagementSystem/teachingAdministration/studentScores/simulationLine/totalScoreLine.vue'],resolve)
    },
    /*单科上线*/
    {
      path:'/subjectLine',
      name:'subjectLine',
      component:resolve=>require(['@/page/schManagementSystem/teachingAdministration/studentScores/simulationLine/subjectLine.vue'],resolve)
    },
    /*上线对比*/
    {
      path:'/compareLine',
      name:'compareLine',
      component:resolve=>require(['@/page/schManagementSystem/teachingAdministration/studentScores/simulationLine/compareLine.vue'],resolve)
    },
    /*wqq-排课管理*/
    {
    ...
    {
      path:'/handleLiteracyAssess/:id',//编辑考核方向
    ...
    {
      path:'/studentAssessScore',//学生素养评分
      name:'studentAssessScore',
      component: resolve => require(['@/page/schManagementSystem/researchManagement/studentLiteracy/studentAssessScore.vue'], resolve)
    },
    {
      path:'/ChildAssessScore/:id',//评分
      name:'ChildAssessScore',
      component: resolve => require(['@/page/schManagementSystem/researchManagement/studentLiteracy/ChildAssessScore.vue'], resolve)
    },
    /*教师考评*/
    {
    ...
    {
      path:'/addEvaluationPerson/:id',//添加被评人员
    ...
    {
      path:'/evaluationProgress/:id',//考评进度跟踪
    ...
    {
      path:'/changeEvaluationProgram/:id',//修改评分方案
    ...
    /*角色信息管理*/
    {
      ...
      component:resolve=>require(['@/page/schManagementSystem/baseSettings/userManager/roleInformation.vue'],resolve)
    },
    /*个人信息管理*/
    {
      path:'/studentPersonalInformation',
      name:'studentPersonalInformation',
      component:resolve=>require(['@/page/schManagementSystem/baseSettings/userManager/studentPersonalInformation.vue'],resolve)
    },
    /*新生管理*/
    {
    ...
    {
      path:'/newStudentClassName/:gradeId',//新生分班名单
    ...
    {
      path:'/handlerQuestionNaire/:id',//编辑问卷
    ...
    {
      path:'/shareQuestionNaire/:id',//分享问卷
    ...
    {
      path:'/handlerQNaireOther',//分享问卷——校外
      name:'handlerQNaireOther',
      component:resolve=>require(['@/page/schManagementSystem/others/questionNaire/handlerQNaireOther.vue'],resolve)
    },
    {
    ...
    },
    {
      ...
      children:[
        ...
        {
          path:'assetAlreadyApproval/:idx',//已审批
    ...
    {
      path:'/RoleInfor',     //校园管理/基础设置/基本信息/角色信息
      name:'RoleInfor',
      component:resolve => require(['@/page/schManagementSystem/baseSettings/BasicInformation/RoleInfor.vue'], resolve)
    },
    {
    ...
    {
      path:'/teacherManagement',     //校园管理/基础设置/用户管理/教师管理/信息管理
      name:'teacherManagement',
      component:resolve => require(['@/page/schManagementSystem/baseSettings/userManager/teacher/messageManagement'], resolve)
    },
    {
      path:'/teacherImport',     //校园管理/基础设置/用户管理/教师管理/批量导入
      name:'teacherImport',
      component:resolve => require(['@/page/schManagementSystem/baseSettings/userManager/teacher/bulkImport'], resolve)
    },
    {
      path:'/teacherMessageAddOrEdit/:type/:id',     //校园管理/基础设置/用户管理/教师管理/信息录入或修改
      name:'teacherMessageAddOrEdit',
      component:resolve => require(['@/page/schManagementSystem/baseSettings/userManager/teacher/messageAddOrEdit'], resolve)
    },
    {
      path:'/workersManagement',     //校园管理/基础设置/用户管理/职工管理/信息管理
    ...
    {
      path:'/workersImport',     //校园管理/基础设置/用户管理/职工管理/批量导入
      name:'workersImport',
      component:resolve => require(['@/page/schManagementSystem/baseSettings/userManager/workers/bulkImport'], resolve)
    },
    {
      path:'/workerMessageAddOrEdit/:type/:id',     //校园管理/基础设置/用户管理/职工管理/信息录入或修改
      name:'workerMessageAddOrEdit',
      component:resolve => require(['@/page/schManagementSystem/baseSettings/userManager/workers/messageAddOrEdit'], resolve)
    },
    {
      path:'/personalInfoWorker',     //校园管理/基础设置/用户管理/职工管理/职工或者教师个人信息
      name:'personalInfoWorker',
      component:resolve => require(['@/page/schManagementSystem/baseSettings/userManager/workers/personalInfoWorker'], resolve)
    },
    {
      path:'/teacherToWorker',     //校园管理/基础设置/用户管理/教师转职工
      name:'teacherToWorker',
      component:resolve => require(['@/page/schManagementSystem/baseSettings/userManager/teacherToWorker/teacherToWorker'], resolve)
    },
    /*wy*/
    {
    ...
    },
    {
      ...
      children: [{
        ...
        path: 'invigilatorTask/:examinationid',
        ...
        path: 'testReportPrinting/:gradeid/:examinationid',
        ...
        path: 'candidatesArrangement/:examinationid',
        ...
        path: 'importGrades/:examinationid',
        name: 'importGrades',
        ...
        path: 'studentTestAlone/:gradeid/:examinationid',
        ...
        path: 'releaseResults/:examinationid',
        name: 'releaseResults',
        ...
        path: 'testScribing/:examinationid',
        name: 'testScribing',
        ...
        path: 'percentageSet/:examinationid',
        name: 'percentageSet',
        ...
        path: 'scoresLevel/:examinationid',
        name: 'scoresLevel',
        component: resolve => require(['@/page/schManagementSystem/teachingAdministration/schoolExam/examManager/scoresLevel.vue'], resolve)
      },{   //各科目考试时间
        path: 'testTime/:examinationid',
        name: 'testTime',
        component: resolve => require(['@/page/schManagementSystem/teachingAdministration/schoolExam/examManager/testTime.vue'], resolve)
      },{   //监考安排
        path: 'proctorArrangement/:examinationid',
        name: 'proctorArrangement',
        component: resolve => require(['@/page/schManagementSystem/teachingAdministration/schoolExam/examManager/proctorArrangement.vue'], resolve)
      }]
    },
    {
    ...
    {
      path: '/scoreQuery',  //校园管理/本校考试/学生成绩/成绩查询
      name: 'scoreQuery',
    ...
    {
      path:'/subjectCount',  //校园管理/本校考试/学生成绩/学科统计
      name:'subjectCount',
    ...
    {
      path: '/rankingCount',  //校园管理/本校考试/学生成绩/名次统计
      name: 'rankingCount',
    ...
    {
      path: '/subparagraphCount',  //校园管理/本校考试/学生成绩/分段统计
    ...
    {
      path: '/totalCount',  //校园管理/本校考试/学生成绩/均分总表
      name: 'totalCount',
    ...
    {
      path: '/personalResultsQuery',  //校园管理/本校考试/学生成绩/个人成绩——成绩查询
      name: 'personalResultsQuery',
      component: resolve => require(['@/page/schManagementSystem/teachingAdministration/studentScores/personalResults/personalResultsQuery.vue'], resolve)
    },
    {
      path: '/personalResultsContrast',  //校园管理/本校考试/学生成绩/个人成绩——成绩对比
      name: 'personalResultsContrast',
      component: resolve => require(['@/page/schManagementSystem/teachingAdministration/studentScores/personalResults/personalResultsContrast.vue'], resolve)
    },
    {
      ...
      children: [{   //流程图
        ...
        path: 'reviseSubClassPlan/:planId',
        ...
        path: 'subStudentManagement/:planId',
        ...
        path: 'scoresManagement/:planId/:examId',
        ...
        path: 'scoresEntry/:planId/:examId/:subId',
        name: 'scoresEntry',
        ...
        path: 'aggregateScoreCount/:planId',
        ...
        path: 'studentVolunteerRevise/:planId',
        ...
        path: 'importStudentVolunteer/:planId',
        ...
        path: 'studentVolunteerCount/:planId',
        ...
        path: 'volunteerDistributionStatus/:planId',
        ...
        path: 'unFillVolunteerList/:planId',
        ...
        path: 'volunteerConfirmList/:planId',
        ...
        path: 'publishSubClassResult/:planId',
        ...
        path: 'specifiedStudentClass/:planId',
        ...
        path: 'manuallyAdjustment/:planId',
    ...
    {   //校园管理/教学教务/分班分科/分班分科结果——学生
      ...
      component: resolve => require(['@/page/schManagementSystem/teachingAdministration/subClassDivision/subClassDivisionStudent/subClassDivisionResults.vue'], resolve)
    },
    {   //校园管理/教学教务/分班分科/分班成绩查询——学生
      path: '/subClassScoreQuery',
      name: 'subClassScoreQuery',
      component: resolve => require(['@/page/schManagementSystem/teachingAdministration/subClassDivision/subClassDivisionStudent/subClassScoreQuery.vue'], resolve)
    },
    {   //校园管理/教学教务/分班分科/分班成绩明细——学生
      path: '/subClassScoreDetails',
      name: 'subClassScoreDetails',
      component: resolve => require(['@/page/schManagementSystem/teachingAdministration/subClassDivision/subClassDivisionStudent/subClassScoreDetails.vue'], resolve)
    },
    {   //校园管理/教学教务/分班分科/填报分班志愿——学生
      path: '/subClassVolunteerFill',
      name: 'subClassVolunteerFill',
      component: resolve => require(['@/page/schManagementSystem/teachingAdministration/subClassDivision/subClassDivisionStudent/subClassVolunteerFill.vue'], resolve)
    },
    {   //校园管理/教学教务/分班分科/班主任修改学生志愿
      path: '/subClassVolunteerHeadteacher',
      name: 'subClassVolunteerHeadteacher',
      component: resolve => require(['@/page/schManagementSystem/teachingAdministration/subClassDivision/subClassHeadteacher/subClassVolunteerHeadteacher.vue'], resolve)
    },
    {   //校园管理/教学教务/教务管理/在读证明
      path: '/inSchoolProve',
      name: 'inSchoolProve',
    ...
    {   //校园管理/教学教务/教务管理/在读证明预览
      path: '/inSchoolProvePreview/:userId',
      name: 'inSchoolProvePreview',
      component: resolve => require(['@/page/schManagementSystem/teachingAdministration/educationalAdministration/inSchoolProvePreview.vue'], resolve)
    },
    {   //校园管理/教学教务/教务管理/成绩证明
      path: '/scoresProve',
      name: 'scoresProve',
    ...
    {
      path: '/VoluntaryAdjustment',  //教学教务/班级管理/志愿调整（班）
      name: 'VoluntaryAdjustment',
      component: resolve => require(['@/page/schManagementSystem/teachingAdministration/ClassManagement/VoluntaryAdjustment.vue'], resolve)
    },
    {
    ...
    {
      path: '/scheduleTeacher',  //教学教务/课程表（教师权限）
      name: 'scheduleTeacher',
      component: resolve => require(['@/page/schManagementSystem/teachingAdministration/scheduleList/scheduleTeacher.vue'], resolve)
    },
    {
      path: '/scheduleStudent',  //教学教务/课程表（学生&家长权限）
      name: 'scheduleStudent',
      component: resolve => require(['@/page/schManagementSystem/teachingAdministration/scheduleList/scheduleStudent.vue'], resolve)
    },
    {
      path: '/scheduleAdministratorClass',  //教学教务/课程表（管理员权限）
      name: 'scheduleAdministratorClass',
      component: resolve => require(['@/page/schManagementSystem/teachingAdministration/scheduleList/scheduleAdministrator/scheduleAdministratorClass.vue'], resolve)
    },
    {
      path: '/scheduleAdministratorTeacher',  //教学教务/课程表（管理员权限）
      name: 'scheduleAdministratorTeacher',
      component: resolve => require(['@/page/schManagementSystem/teachingAdministration/scheduleList/scheduleAdministrator/scheduleAdministratorTeacher.vue'], resolve)
    },
    {
      path: '/scheduleAdministratorAll',  //教学教务/课程表（管理员权限）
      name: 'scheduleAdministratorAll',
      component: resolve => require(['@/page/schManagementSystem/teachingAdministration/scheduleList/scheduleAdministrator/scheduleAdministratorAll.vue'], resolve)
    },
    {
    ...
    {
      path: '/myGrowthRecord',  //校园管理系统/学生管理/我的成长记录
      name: 'myGrowthRecord',
      component: resolve => require(['@/page/schManagementSystem/studentsManagement/studentGrowthRecord/myGrowthRecord.vue'], resolve)
    },
    {
    ...
    {
      path: '/dormitoryResults',  //校园管理系统/学生管理/宿舍管理/宿舍分配结果
      name: 'dormitoryResults',
      component: resolve => require(['@/page/schManagementSystem/studentsManagement/dormitoryManagement/dormitoryDistributionResult/dormitoryResults.vue'], resolve)
    },
    {
    ...
    },
    {
      ...
      children: [{
        ...
        path: 'distributionPersonnelList/:planId',
        ...
        path: 'distributionDormitoryMsg/:planId',
        ...
        path: 'specifiedStudentDormitory/:planId',
        ...
        path: 'manuallyAdjustmentDormitory/:planId',
        ...
        path: 'dormitoryPrintReport/:planId',
        ...
        path: 'fastDistributionDormitory/:planId',
    ...
    {
      path: '/unSpecifiedTurningClass',  //校园管理系统/教学教务/调课代课/调课/教师非指定调课——调课申请
      name:'unSpecifiedTurningClass',
      component: resolve => require(['@/page/schManagementSystem/teachingAdministration/turningClassSubstitute/turningClass/unSpecifiedTurningClass.vue'], resolve)
    },
    {
      path: '/turningClassMatching',  //校园管理系统/教学教务/调课代课/调课/教师非指定调课——调课匹配
      name:'turningClassMatching',
      component: resolve => require(['@/page/schManagementSystem/teachingAdministration/turningClassSubstitute/turningClass/turningClassMatching.vue'], resolve)
    },
    {
      path: '/classTurningClass',  //校园管理系统/教学教务/调课代课/调课/班级调课
      name:'classTurningClass',
      component: resolve => require(['@/page/schManagementSystem/teachingAdministration/turningClassSubstitute/turningClass/classTurningClass.vue'], resolve)
    },
    {
      path: '/turningClassPendingApproved',  //校园管理系统/教学教务/调课代课/调课/调课申请审批——待审批
      name:'turningClassPendingApproved',
      component: resolve => require(['@/page/schManagementSystem/teachingAdministration/turningClassSubstitute/turningClass/turningClassPendingApproved.vue'], resolve)
    },
    {
      path: '/turningClassApproved',  //校园管理系统/教学教务/调课代课/调课/调课申请审批——已审批
      name:'turningClassApproved',
      component: resolve => require(['@/page/schManagementSystem/teachingAdministration/turningClassSubstitute/turningClass/turningClassApproved.vue'], resolve)
    },
    {
      path: '/turningClassAllApproved',  //校园管理系统/教学教务/调课代课/调课/调课申请审批——全部
      name:'turningClassAllApproved',
      component: resolve => require(['@/page/schManagementSystem/teachingAdministration/turningClassSubstitute/turningClass/turningClassAllApproved.vue'], resolve)
    },
    {
      path: '/turningClassRecords',  //校园管理系统/教学教务/调课代课/调课/调课申请记录
      name:'turningClassRecords',
      component: resolve => require(['@/page/schManagementSystem/teachingAdministration/turningClassSubstitute/turningClass/turningClassRecords.vue'], resolve)
    },
    {
      path: '/substituteApplication',  //校园管理系统/教学教务/调课代课/代课/代课申请
      name:'substituteApplication',
      component: resolve => require(['@/page/schManagementSystem/teachingAdministration/turningClassSubstitute/substitute/substituteApplication.vue'], resolve)
    },
    {
      path: '/substitutePendingApproved',  //校园管理系统/教学教务/调课代课/代课/代课申请审批——待审批
      name:'substitutePendingApproved',
      component: resolve => require(['@/page/schManagementSystem/teachingAdministration/turningClassSubstitute/substitute/substitutePendingApproved.vue'], resolve)
    },
    {
      path: '/substituteApproved',  //校园管理系统/教学教务/调课代课/代课/代课申请审批——已审批
      name:'substituteApproved',
      component: resolve => require(['@/page/schManagementSystem/teachingAdministration/turningClassSubstitute/substitute/substituteApproved.vue'], resolve)
    },
    {
      path: '/substituteAllApproved',  //校园管理系统/教学教务/调课代课/代课/代课申请审批——全部
      name:'substituteAllApproved',
      component: resolve => require(['@/page/schManagementSystem/teachingAdministration/turningClassSubstitute/substitute/substituteAllApproved.vue'], resolve)
    },
    {
      path: '/substituteRecords',  //校园管理系统/教学教务/调课代课/代课/代课申请记录
      name:'substituteRecords',
      component: resolve => require(['@/page/schManagementSystem/teachingAdministration/turningClassSubstitute/substitute/substituteRecords.vue'], resolve)
    },
    {
      path: '/classCount',  //校园管理系统/教学教务/调课代课/课时统计
      name:'classCount',
      component: resolve => require(['@/page/schManagementSystem/teachingAdministration/turningClassSubstitute/classCount/classCount.vue'], resolve)
    }
  ]
})
